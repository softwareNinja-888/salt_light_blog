  ...
  return (
    ...
    >
      ...
      <input
        ...
        className= " dark:bg-theme dark:text-white text-black w-11/12 px-4 py-2 pr-10 border border-black rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
      />
