...
export function Footer(){        
    ...
    return (
        <section className="py-10 bg-gradient-to-t from-black to-[#1A1A1A] sm:pt-16 lg:pt-24">
        {/* <SuccessMsg isVisible={isVisible} setIsVisible={setIsVisible}/> */}
            ...
            <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
                    <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                        ...
                        <ul className="flex items-center space-x-3 mt-9">
                            <li>
                                <a href="#" title="" className="flex items-center justify-center text-white transition-all duration-200 bg-gray-800 rounded-full w-7 h-7 hover:bg-greenPrimary focus:bg-greenPrimary">
                    ...
                    <div>
                        ...
                        <ul className="mt-6 space-y-4">
                            <li>
                                <NavLink to='/about' className="flex text-base text-white transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> 
                                    About
                                </NavLink>
                            </li>
                    ...
                    <div>
                        ...
                        <ul className="mt-6 space-y-4">
                            <li>
                                <NavLink to='/faq' className="flex text-base text-white transition-all duration-200 hover:text-blue-600 focus:text-blue-600">
                                    FAQ
                                </NavLink>
                            </li>
                    ...
                    <div className="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
                        ...
                        <form action="" method="" className="flex flex-col gap-4 mt-6">
                            <div>
                                ...
                                <input type="text" name="name" id="name" placeholder="Enter your name" className="block w-full p-4 text-black placeholder-gray-500 transition-all duration-200 bg-white border border-gray-200 rounded-md focus:outline-none focus:border-greenPrimary caret-greenPrimary" />
                            </div>
                            <div>
                                <label htmlFor="email" className="sr-only">Email</label>
                                <input type="email" name="email" id="email" placeholder="Enter your email" className="block w-full p-4 text-black placeholder-gray-500 transition-all duration-200 bg-white border border-gray-200 rounded-md focus:outline-none focus:border-greenPrimary caret-greenPrimary" />
                            </div>
                            {/* ADD TEXT AREA HERE */}
                            <div>
                                <label htmlFor="email" className="sr-only">Message</label>
                                <textarea name="message" id="message" placeholder='Your Message' className='block w-full p-4 text-black placeholder-gray-500 transition-all duration-200 bg-white border border-gray-200 rounded-md focus:outline-none focus:border-greenPrimary caret-greenPrimary resize-none h-44'></textarea>
                            </div>

                            <button type="button" className="inline-flex items-center justify-center px-6 py-4 mt-3 font-inter700 text-white transition-all duration-200 bg-blue-600 rounded-md hover:bg-blue-700 focus:bg-blue-700 cursor-pointer hover:scale-102" onClick={()=>{setIsVisible(true)}}>Subscribe</button>
                        </form>
                    </div>
                </div>
                ...
                <p className="text-sm text-center text-white font-extralight">© Copyright 2021, All Rights Reserved by {companyName}</p>
            </div>
        </section>
