...
import { DefaultColumn,NameInput,MessageTextarea,EmailInput,DefaultInput} from "@src/util/util";
        ...
        <>
            <div className="flex py-0">
                <div className="flex-1 ">
                    <img src="/hero1.avif" alt="" className="h-full" />
                </div>
                <section className="bg-gray-1 py-20 dark:bg-dark lg:py-[12px] flex-1 ">
                    <div className="container mx-auto">
                        <div className="-mx-4 flex flex-wrap">
                            <div className="w-full px-4">
                            <div className="relative mx-auto max-w-[525px] overflow-hidden rounded-lg bg-white dark:bg-black px-10 py-16 text-center dark:bg-dark-2 sm:px-12 md:px-[60px]">
                                ...
                                <form>
                                    ...
                                    <DefaultColumn>
                                        <EmailInput email={email} setEmail={setEmail} width='w-full' />
                                    </DefaultColumn>
                                    <DefaultColumn>
                                        <DefaultInput name="Password" placeholder='Password' width='w-full'/>
                                    </DefaultColumn>
                                    <div className="mb-10">
                                        <input
                                        type="submit"
