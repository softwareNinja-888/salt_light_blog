...
import { NameIcon, EmailIcon, PasswordIcon } from "../../util/util";
    ...
    return (
        <>
             <form onSubmit={handleSubmit} className="flex flex-col justify-center items-center gap-5 ">
                <Input title='Name' type='text' placeholder='John Doe' width='w-90' field={name} setField={setName} section='nameSignUp' styles='' IconRender={() => <NameIcon />} />
