...
export function BlogOfWeek(){
    ...
    console.log('blog:',BlogOfWeek)
    
    return (
        <>
            <div className="flex bg-center bg-cover bg-no-repeat h-72 px-5 py-5 relative w-10/12 border border-black " style={{backgroundImage: `url('${BlogOfWeek.imgPath(true)}')`}}>
