...
export const commentsData = [
  // Blog 0: The Power of Faith in Difficult Times
  [
    {
      id: 1,
      name: "Grace M.",
      text: "This post reminded me to lean on God more during my struggles. Thank you!",
      img: "https://landingfoliocom.imgix.net/store/collection/clarity-blog/images/hero/3/avatar-1.png"
    },
    {
      id: 2,
      name: "Paul T.",
      text: "Faith is truly our anchor. Beautiful reminder.",
      img: "https://landingfoliocom.imgix.net/store/collection/clarity-blog/images/hero/3/avatar-2.png"
    },
    {
      id: 3,
      name: "Naomi B.",
      text: "Needed this today. God bless you for sharing!",
      img: "https://landingfoliocom.imgix.net/store/collection/clarity-blog/images/hero/3/avatar-3.png"
    }
  ],
  // Blog 1: Finding Peace Through Prayer
  [
    {
      id: 4,
      name: "Samuel D.",
      text: "Prayer has changed my life in ways I can't explain. Great article!",
      img: "https://landingfoliocom.imgix.net/store/collection/clarity-blog/images/hero/3/avatar-4.png"
    },
    {
      id: 5,
      name: "Linda K.",
      text: "The verse from Philippians always comforts me. Amen!",
      img: "https://landingfoliocom.imgix.net/store/collection/clarity-blog/images/hero/3/avatar-5.png"
    }
  ],
  // Blog 2: Scripture: A Lamp to Our Feet
  [
    {
      id: 6,
      name: "Joseph A.",
      text: "I love how you emphasized Scripture as a living guide. It's so true!",
      img: "https://landingfoliocom.imgix.net/store/collection/clarity-blog/images/hero/3/avatar-6.png"
    },
    {
      id: 7,
      name: "Eliza N.",
      text: "The Bible truly lights our path. Beautifully written.",
      img: "https://landingfoliocom.imgix.net/store/collection/clarity-blog/images/hero/3/avatar-7.png"
    }
  ],
  // Blog 3: Living a Life of Worship
  [
    {
      id: 8,
      name: "Brian C.",
      text: "Worship as a lifestyle—that really resonated with me.",
      img: "https://landingfoliocom.imgix.net/store/collection/clarity-blog/images/hero/3/avatar-7.png"
    },
    {
      id: 9,
      name: "Tasha R.",
      text: "This blessed me. May we all live lives of praise!",
      img: "https://landingfoliocom.imgix.net/store/collection/clarity-blog/images/hero/3/avatar-6.png"
    },
    {
      id: 10,
      name: "David Y.",
      text: "I’m going to share this with my Bible study group!",
      img: "https://landingfoliocom.imgix.net/store/collection/clarity-blog/images/hero/3/avatar-5.png"
    }
  ],
  // Blog 4: Embracing God’s Unconditional Love
  [
    {
      id: 11,
      name: "Sarah Z.",
      text: "Such a comforting post. God's love never fails.",
      img: "https://landingfoliocom.imgix.net/store/collection/clarity-blog/images/hero/3/avatar-4.png"
    },
    {
      id: 12,
      name: "Mike F.",
      text: "Romans 8:38-39 is one of my favorite passages. Thanks for sharing.",
      img: "https://landingfoliocom.imgix.net/store/collection/clarity-blog/images/hero/3/avatar-3.png"
    }
  ],
  // Blog 5: Overcoming Trials Through Christ
  [
    {
      id: 13,
      name: "Rachel M.",
      text: "James 1:2-4 has helped me through tough times. This post encouraged me.",
      img: "https://landingfoliocom.imgix.net/store/collection/clarity-blog/images/hero/3/avatar-1.png"
    },
    {
      id: 14,
      name: "Tom J.",
      text: "We are never alone. Thank you, Jesus!",
      img: "https://landingfoliocom.imgix.net/store/collection/clarity-blog/images/hero/3/avatar-2.png"
    }
  ],
  // Blog 6: Walking in the Light of the Lord
  [
    {
      id: 15,
      name: "Betty A.",
      text: "I loved the reminder that Jesus is our light. So powerful!",
      img: "https://landingfoliocom.imgix.net/store/collection/clarity-blog/images/hero/3/avatar-1.png"
    },
    {
      id: 16,
      name: "George P.",
      text: "Let’s keep sharing that light with the world!",
      img: "https://landingfoliocom.imgix.net/store/collection/clarity-blog/images/hero/3/avatar-5.png"
    }
  ],
  // Blog 7: The Journey of Spiritual Renewal
  [
    {
      id: 17,
      name: "Daniel W.",
      text: "This really spoke to my current season. Thank you for writing it.",
      img: "https://landingfoliocom.imgix.net/store/collection/clarity-blog/images/hero/3/avatar-7.png"
    },
    {
      id: 18,
      name: "Julia C.",
      text: "Every day is a new chance to be renewed—amen!",
      img: "https://landingfoliocom.imgix.net/store/collection/clarity-blog/images/hero/3/avatar-6.png"
    }
  ],
  // Blog 8: Trusting God in Uncertain Times
  [
    {
      id: 19,
      name: "Kevin H.",
      text: "These truths are so needed in today’s world. Powerful message.",
      img: "https://landingfoliocom.imgix.net/store/collection/clarity-blog/images/hero/3/avatar-3.png"
    },
    {
      id: 20,
      name: "Monica L.",
      text: "Trusting God has given me peace in chaos. Thank you for this.",
      img: "https://landingfoliocom.imgix.net/store/collection/clarity-blog/images/hero/3/avatar-4.png"
    }
  ],
  // Blog 9: Renewed by the Spirit
  [
    {
      id: 21,
      name: "Andrew S.",
      text: "The Holy Spirit renews me daily. This post gave me life!",
      img: "https://landingfoliocom.imgix.net/store/collection/clarity-blog/images/hero/3/avatar-1.png"
    },
    {
      id: 22,
      name: "Cynthia E.",
      text: "I feel empowered after reading this. God bless!",
      img: "https://landingfoliocom.imgix.net/store/collection/clarity-blog/images/hero/3/avatar-2.png"
    }
  ],
  // Blog 10: The Gift of Grace
  [
    {
      id: 23,
      name: "Felicia B.",
      text: "God’s grace is everything. This was beautiful!",
      img: "https://landingfoliocom.imgix.net/store/collection/clarity-blog/images/hero/3/avatar-3.png"
    },
    {
      id: 24,
      name: "Oscar N.",
      text: "We are saved by grace through faith. What a blessing!",
      img: "https://landingfoliocom.imgix.net/store/collection/clarity-blog/images/hero/3/avatar-5.png"
    }
  ],
  // Blog 11: Bearing Fruit in Every Season
  [
    {
      id: 25,
      name: "Irene T.",
      text: "Even in hard times, I want to bear fruit. Thank you for this encouragement!",
      img: "https://landingfoliocom.imgix.net/store/collection/clarity-blog/images/hero/3/avatar-7.png"
    },
    {
      id: 26,
      name: "Martin G.",
      text: "So relevant. Let’s be fruitful in all seasons.",
      img: "https://landingfoliocom.imgix.net/store/collection/clarity-blog/images/hero/3/avatar-2.png"
    }
  ]
];
